...
My research interests mainly revolve around RLHF, RLVR, AIGC, and 3D Human Modeling. I am actively seeking (1) `Ph.D. positions` for Fall 2027, and (2) other `research collaborations` related to RL or AIGC. Feel free to reach out via 📧 Email: `xiaofengtan@seu.edu.cn` or 💬 WeChat: `txf_06_20`. I'd be happy to connect 😊. And if you'd like to talk about [*Doraemon*](https://en.wikipedia.org/wiki/Doraemon) 😺, that works too. For more details, please check my [CV](/assets/pdf/CV_Xiaofeng_Tan.pdf) / [中文简历](/assets/pdf/CV_Xiaofeng_Tan_CN.pdf).

> 🌐 Personal Homepage: https://xiaofeng-tan.github.io/
